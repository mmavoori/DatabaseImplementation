...
void test2 () {
	...
	cout << "\nScanned " << counter << " recs \n";
	
	dbfile.MoveFirst ();
	
	cout<<"1: "; dbfile.GetNext (temp);
	cout<<"2: "; dbfile.Add (temp);
	
	cout<<"3: "; dbfile.GetNext (temp);
	cout<<"4: "; dbfile.GetNext (temp);
	cout<<"5: "; dbfile.GetNext (temp);
	cout<<"6: "; dbfile.GetNext (temp);
	cout<<"7: "; dbfile.GetNext (temp);
	
	cout<<"8: "; dbfile.Add (temp);
	cout<<"9: "; dbfile.GetNext (temp);
	cout<<"10: "; dbfile.Add (temp);
